...
class Menu(arcade.Section):
    ...
    def __init__(self, left, bottom, width, height):
        ...
        self.shift_x = (self.width - self.left) // columns
        self.shift_y = (self.height - self.bottom) // rows


        self.available_area = [self.left, self.bottom, self.width, self.height]
        ...
        self.first_animation_mode_btn = Buttons.add_texture_button(
            ...
            _scale=1.5,
            _x=self.left + self.shift_x,
            _y=self.bottom + 8 * self.shift_y
        )
        ...
        self.close_btn = Buttons.add_texture_button(
            ...
            _scale=.05,
            _x=self.left + 6.5 * self.shift_x,
            _y=self.bottom + 10*self.shift_y
        )
